...
$result = $db1->query("SELECT COUNT(*) AS count FROM BILL1 WHERE POSE='SALE'"); 
...
$result = $db1->query("SELECT * FROM BILL1 WHERE POSE='SALE' ORDER BY $sidx $sord LIMIT $start , $limit"); 

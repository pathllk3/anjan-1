...
$result = $db1->query("SELECT * FROM BILLS WHERE POSE='SALE' ORDER BY BDATE, BILLID"); 
$i=2;
$j=1;
$MON = 0;
while($row = $result->fetch_assoc()) {
	...
	$style = array('font' => array('size' => 12,'bold' => true,'color' => array('rgb' => '00ffff')));
	...
	$EXL->getActiveSheet()->getStyle("A".$i1.":S".$i1)->getFill()->getStartColor()->setARGB('8000ff');
	$i++;
	$j++;
}
...
$EXL->getActiveSheet()->getStyle('A1:S1')->getFill()->getStartColor()->setARGB('80ff00');
$styleArray = array(
  'borders' => array(
    'allborders' => array(
